        ...
        $.ajax({
            ...
            success:function (msg) {
                ...
                for (i in files){
                    ...
                    }else if(postname == 'zip'){
                        file_table.append(file_fa.removeClass('fa-file').addClass('fa-file-zip-o').parents('.file-box')[0])
                    }else if(postname == 'cer' || postname == 'pfx' || postname == 'pem') {
                        file_table.append(file_fa.removeClass('fa-file fa').addClass('iconfont icon-zhengshu-copy').parents('.file-box')[0])
                    }else{
                        file_table.append(file_fa.parents('.file-box')[0])
                    }
